      ...
      for (var H = 0, X = _.length, Jt = X >>> 1; H < Jt; ) {
        ...
        if (0 > l(hl, z))
          hn < X && 0 > l(qt, hl)
            ? ((_[H] = qt), (_[hn] = z), (H = hn))
            : ((_[H] = hl), (_[vn] = z), (H = vn));
        else if (hn < X && 0 > l(qt, z)) (_[H] = qt), (_[hn] = z), (H = hn);
        else break;
      }
    }
    return N;
  ...
  el = A({}, Xt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== dt &&
            (dt && e.type === "mousemove"
              ? ((_l = e.screenX - dt.screenX), (Cl = e.screenY - dt.screenY))
              : (Cl = _l = 0),
            (dt = e)),
          _l);
    },
...
function Gs(e, n) {
  ...
  if (Tr) throw ((e = ou), (Tr = !1), (ou = null), e);
}
function D(e, n) {
  var t = n[hu];
...
function Li(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    Cr(e, n), Pa(n, t, r), Eu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function dd(e, n) {
  ...
  for (pu = { focusedElem: e, selectionRange: t }, Mr = !1, k = n; k !== null; )
...
function Zr(e, n) {
  ...
  while (!0);
  if ((so(), (R = t), (Yr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function hd() {
  for (; Q !== null; ) Ka(Q);
...
ys = xo;
gs = zn;
var zd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, vs, hs, xo] },
  vt = {
...
function Rd() {
  return Hl.jsx("h1", {
    className: "text-3xl underline text-red-500",
    children: "Hello world!!",
  });
}
Wl.createRoot(document.getElementById("root")).render(
  Hl.jsx(gc.StrictMode, { children: Hl.jsx(Rd, {}) }),
);
